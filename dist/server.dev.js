...
app.post('/PullThiscCategory', function _callee12(req, res) {
...
app.post('/Searchdeta', function _callee13(req, res) {
...
app.post('/PullInformation', function _callee14(req, res) {
  var e, data;
...
app.put("/update", function _callee15(req, res) {
...
app.get('/get-details-users:userId', function _callee16(req, res) {
  var userId, findUser;
